(ns marketentry.registry
  ...
  own -- BOL's flagship governor check
  (`marketentry.governor/incumplidos-listed-violations`) is a plain
  incumplidos-list-membership boolean read off the engagement record,
